...
public class jawakening {
	...
	public static void main(String[] args) {
		...
		//Talletetaan valinta muuttujaan vaikeustaso. Muuttujan arvo = elämien määrä (hyödynnetään for loopissa)
		...
		System.out.println("\"" + hahmoNimi + "… olenko se todella minä?” ajattelet kun nouset jaloillesi ja näet vieressä olevan tien vievän syvälle metsään."
